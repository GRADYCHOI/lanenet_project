...
#lanenet_cfg = Config(config_path='/aveesSSD/lanenet_ws/src/lanenet_ros/script/config/tusimple_lanenet.yaml')
lanenet_cfg = Config(config_path='/home/choiin/lanenet_ws/src/lanenet_ros/scripts/config/tusimple_lanenet.yaml')
